...
<table class='gwpm-table' style="width: 99%">
<tbody>
	<tr>
		<td >
			<div class="gwpm_profile_pic_div">
            	<a class="gwpm_profile_link"
            		...
            		<span class="gwpm-help">Click to view full image</span>
            	</a>
            </div> 
		</td>
	</tr> 
	<tr><td><div class="gwpm_about_you"><?php gwpm_echo( $modelObj->description ); ?></div></td></tr>
</tbody>
</table>
<table class='gwpm-table'>
		<tbody>
			...
			<tr>
				...
				<td valign="top">
					<?php echo ( $modelObj->gwpm_address['state'] ) ; 	?>
				</td>
			</tr>
			<tr >
				<td valign="top"><?php _e('Country', 'genie-wp-matrimony') ?>:</td>
				<td valign="top"> 
					<?php echo ( $modelObj->gwpm_address['country'] ) ; 	?>
				</td>
			</tr>
			<tr >
				<td valign="top"><?php _e('Zip / Postal Code', 'genie-wp-matrimony') ?>:</td>
				<td valign="top"> 
					<?php echo ( $modelObj->gwpm_address['pin'] ) ; ?>
				</td>
			</tr>
      		<tr>
				<td colspan="2">  
