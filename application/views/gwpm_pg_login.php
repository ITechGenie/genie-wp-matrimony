...
<p>
<?php 
echo __("You are either not authorized or the page you requested is not available. ", 'genie-wp-matrimony') ;
...
<?php
	...
	if ($userPref == 1) {
		...
		gwpm_echo( getBulletImg() . "Click <a href='" .
		        get_option( 'siteurl' ) . "/wp-admin/profile.php'>Here</a> to update your profile, if you have already registered or <br />"  . getBulletImg() . "Click <a href='" .
